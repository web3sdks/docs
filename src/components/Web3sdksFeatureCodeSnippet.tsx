...
export default function Web3sdksFeatureCodeSnippet({
  featureName,
  languageFunctionMapping,
  showHr = true,
}: Props) {
  ...
  const languagesToShow = {
    react: {
      ...
      key: "javascript",
      syntax: "jsx",
      docsLink: "https://docs.web3sdks.com/react",
    },
    javascript: {
      label: "Javascript",
      key: "javascript",
      syntax: "javascript",
      docsLink: "https://docs.web3sdks.com/typescript",
    },
    python: {
      label: "Python",
      key: "python",
      syntax: "python",
      docsLink: "https://docs.web3sdks.com/python",
    },
    go: {
      label: "Go",
      key: "go",
      syntax: "go",
      docsLink: "https://docs.web3sdks.com/go",
    },
    unity: {
      label: "Unity",
      key: "unity",
      syntax: "csharp",
      docsLink: "https://docs.web3sdks.com/unity",
    },
  };

  return (
    <>
      <Tabs groupId={"web3sdks-code-snippet"} defaultValue={"react"}>
