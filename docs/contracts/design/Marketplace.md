...
The document is written for technical and non-technical readers. To ask further questions about `Marketplace`, please join the [web3sdks discord](https://discord.gg/KX2tsh9A) or create a [github issue](https://github.com/web3sdks/contracts/issues).
