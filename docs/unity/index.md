...
<h1 align="center">web3sdks Unity SDK</h1>
<p align="center">
...
Head over to the [releases](https://github.com/web3sdks/unity-sdk/releases) page and download the latest `.unitypackage` file.
...
- Open `Player settings` > `Resolution and Presentation` and under `WebGLTemplate` choose `Web3sdks`.
...
var sdk = new Web3sdksSDK("goerli");
...
See full documentation on the [web3sdks portal](https://docs.web3sdks.com).
