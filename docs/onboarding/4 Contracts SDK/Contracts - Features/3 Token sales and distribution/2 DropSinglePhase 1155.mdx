...
```solidity
import "@web3sdks/contracts/extension/DropSinglePhase1155.sol";
```
...
<ViewContractCodeButton
  link="https://github.com/web3sdks/contracts/blob/main/contracts/extension/DropSinglePhase1155.sol"
