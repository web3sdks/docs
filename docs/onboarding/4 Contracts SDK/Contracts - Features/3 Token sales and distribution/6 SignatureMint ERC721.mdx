...
```solidity
import "@web3sdks/contracts/extension/SignatureMintERC721.sol";
```
...
<ViewContractCodeButton
  link="https://github.com/web3sdks/contracts/blob/main/contracts/extension/SignatureMintERC721.sol"
