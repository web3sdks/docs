...
```solidity
import "@web3sdks/contracts/extension/DelayedReveal.sol";
```
...
`DelayedReveal` uses the [`LazyMint`](/contractkit/extension-contracts/lazymint) extension. When first lazy minting tokens, you can encrypt the metadata of NFTs and can reveal this metadata once your lazy minted NFTs have been distributed. You can learn more about how delayed reveal NFTs work, in this [blogpost](https://blog.web3sdks.com/delayed-reveal-nfts).

<ViewContractCodeButton
  link="https://github.com/web3sdks/contracts/blob/main/contracts/extension/DelayedReveal.sol"
  name="DelayedReveal"
/>
...
import "@web3sdks/contracts/base/ERC721LazyMint.sol";
import "@web3sdks/contracts/extension/DelayedReveal.sol";
...
- Learn more about the usage of this function in this [blogpost](https://blog.web3sdks.com/delayed-reveal-nfts).
