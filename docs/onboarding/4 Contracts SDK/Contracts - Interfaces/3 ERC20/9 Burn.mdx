...
<ViewContractCodeButton
  link="https://github.com/web3sdks/contracts/blob/main/contracts/extension/interface/IBurnableERC20.sol"
  name="ERC20"
  isInterface={true}
/>
...
import "@web3sdks/contracts/extension/interface/IBurnableERC20.sol";
