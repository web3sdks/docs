...
```bash
npx web3sdks@latest create app --next --ts --evm
```
...
In our [example repository](https://github.com/web3sdks-template/firebase-auth), we have additional functionality available to:
