...
<div className="row" style={{ marginBottom: 12 }}>
  <div className="col col--12" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdks.com/guides/how-to-add-web3-sign-in-with-web3sdks/"
...
<div className="row">
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Next.js"
      link="https://docs.web3sdks.com/auth/frameworks/next"
      description=""
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Next.js + Solana"
      link="https://docs.web3sdks.com/auth/solana"
      description=""
      image="/assets/languages/nextjs.png"
    />
  </div>
...
<div className="row">
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="React"
      link="https://docs.web3sdks.com/auth/frameworks/react"
      description=""
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Express"
      link="https://docs.web3sdks.com/auth/frameworks/express"
      description=""
...
<div className="row">
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Flask"
      link="https://github.com/web3sdks-template/web3sdks-auth-flask"
      description=""
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Fiber"
      link="https://github.com/web3sdks-template/web3sdks-auth-fiber"
      description=""
...
<div className="row" style={{ marginTop: 24 }}>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="NextAuth"
      link="https://github.com/web3sdks-template/web3sdks-auth-next-auth"
      description=""
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Supabase"
      link="https://github.com/web3sdks-template/web3sdks-auth-supabase"
      description=""
...
<div className="row" style={{ marginTop: 24 }}>
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdks.com/guides/nft-gated-website/"
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdks.com/guides/add-stripe-subscriptions-with-web3-auth/"
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdks.com/guides/create-a-discord-bot-that-gives-nft-holders-a-role/"
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.web3sdks.com/guides/how-to-create-a-web3-creator-platform/"
