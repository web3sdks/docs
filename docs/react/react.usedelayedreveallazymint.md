...
>(
  ...
  import("@web3sdks/sdk").TransactionResultWithId<never>[],
  unknown,
...
import("@tanstack/react-query").UseMutationResult&lt;import("@web3sdks/sdk").TransactionResultWithId&lt;never&gt;\[\], unknown, [DelayedRevealLazyMintInput](./react.delayedreveallazymintinput.md), unknown&gt;
