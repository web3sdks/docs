...
```jsx
import { useProgram, useTransferToken } from "@web3sdks/react/solana";
...
import("@tanstack/react-query").UseMutationResult&lt;import("@web3sdks/sdk/solana").TransactionResult, unknown, [TransferTokenMutationParams](./react.transfertokenmutationparams.md), unknown&gt;
