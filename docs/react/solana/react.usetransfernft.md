...
```jsx
import { useProgram, useTransferNFT } from "@web3sdks/react/solana";
...
import("@tanstack/react-query").UseMutationResult&lt;import("@web3sdks/sdk/solana").TransactionResult, unknown, [TransferNFTMutationParams](./react.transfernftmutationparams.md), unknown&gt;
