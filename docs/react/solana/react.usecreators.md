...
```jsx
import { useProgram, useCreators } from "@web3sdks/react/solana";
...
export declare function useCreators(
  ...
  import("@web3sdks/sdk/solana").CreatorOutput[],
  unknown
>;
```
...
import("@tanstack/react-query").UseQueryResult&lt;import("@web3sdks/sdk/solana").CreatorOutput\[\], unknown&gt;
